		...
		<div class="sidebar-menu">
			<ul class="menu">
				...
				<div class="sidemenu-layout">
					<div>
						<li class="sidebar-item"><a href="/medgo/main" class="sidebar-link"> <i class="bi bi-grid-fill"></i> <span>메인화면</span>
						</a></li>
					...
					<li class="sidebar-item" id="logout-button"><a href="http://localhost:8088/medgo/login" class="sidebar-link"> <i class="fas fa-sign-out-alt"></i> <span>로그아웃</span>
					</a></li>
				</div>
			</ul>
		</div>
