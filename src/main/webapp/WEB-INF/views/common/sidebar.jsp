	...
	<div class="sidebar-wrapper active">
		<div class="sidebar-header">
			<div class="d-flex justify-content-between">
				<div class="logo">
					<a href="/medgo/pharmacy/"><img src="${pageContext.request.contextPath}/resources/dist/assets/images/logo/logo.png" alt="Logo" srcset="" /> <span id="logo-title">약찾GO</span> </a>
				</div>
				<div class="toggler">
		...
		<div class="sidebar-menu">
			<ul class="menu">
				...
				<div class="sidemenu-layout">
					<div>
						<li class="sidebar-item"><a href="/medgo/pharmacy/" class="sidebar-link"> <i class="bi bi-grid-fill"></i> <span>메인화면</span>
						</a></li>
					...
					<li class="sidebar-item" id="logout-button"><a href="/login" class="sidebar-link"> <i class="fas fa-sign-out-alt"></i> <span>로그아웃</span>
					</a></li>
				</div>
			</ul>
		</div>
