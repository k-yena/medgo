...
<body>
				...
				<div
					...
					<div class="modal-content">
										...
										<div class="row">
											...
											<div class="col-12">
												<div class="form-group">
													...
													<textarea type="text" id="notice-edit-content"
						...
						<div class="modal-footer notice-btns">
							<a href="#" class="btn btn-outline-secondary edit-btn">수정</a> <a
								href="#" class="btn btn-outline-danger delete-btn">삭제</a>
						</div>
					</div>
				</div>
			</div>
	...
	<!-- 여기까지 script.html -->
	<script
		src="${pageContext.request.contextPath}/resources/dist/assets/js/pages/notice-page.js"></script>
</body>
</html>
