...
<html lang="en">
  ...
  <body>
          ...
          >
            <div class="modal-content">
                      ...
                      <div class="row">
                        <div class="col-12">
                          <div class="form-group">
                            <label for="notice-edit-title">공지사항 제목</label>
                            <input
                              type="text"
              ...
              <div class="modal-footer notice-btns">
                <a href="#" class="btn btn-outline-secondary edit-btn">수정</a>
                <a href="#" class="btn btn-outline-danger delete-btn">삭제</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- 여기까지 script.html -->
    <script src="/resources/dist/assets/js/pages/notice-page.js"></script>
  </body>
</html>
