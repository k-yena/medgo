...
<body>
	<div class="mobile-frame">
		...
		<div id="main-app-screen" class="app-screen">
			...
			<div class="search-box">
				<i id="search-back-button" class="bi bi-chevron-left"
					style="display: none"></i> <input type="text" class="form-control"
		...
		<div class="bottom-panel">
			...
			<button class="alt-search-btn btn btn-outline-primary"
				onclick="showAlternatives()" style="display: none">대체약 검색</button>
	...
	<script type="text/javascript"
		src="//dapi.kakao.com/v2/maps/sdk.js?appkey=ef69cf49abf5e7e492aed45e7a8e1021"></script>
	<script
	...
	<script
		src="${pageContext.request.contextPath}/resources/dist/assets/js/customer.js"></script>
</body>
</html>
