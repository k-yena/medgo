...
<body>
			...
			<div class="page-heading">
				<div class="page-title">
					<div class="row">
						<div class="col-12 col-md-6 order-md-1 order-last">
							<h3>신규 약 등록</h3>
							<p class="text-subtitle text-muted">식약청에 등록된 약품을 검색하고 신규 약품을 등록합니다.</p>
						</div>
				...
				<section class="section">
					<div class="card">
						...
						<div class="card-body">
							<form method="get" action="<c:url value='/pharmacy/drugs/new'/>" class="row g-2 mb-3 align-items-center" id="searchForm">
								...
								<table class="table table-striped" id="table1">
									...
									<thead>
										<tr>
											...
											<th scope="col" class="sortable" data-sort="drugType">의약품구분</th>
										</tr>
									</thead>
									<tbody>
			...
			<div class="modal-content">
					...
					<div class="table-responsive">
						<table class="table mb-0 table-hover">
							<tbody>
								...
								<tr>
									<th scope="row">의약품구분</th>
									<td id="modal-drugType">rrr</td>
								</tr>
							</tbody>
						</table>
					</div>
				...
				<div class="modal-footer justify-content-between">
					...
					<div>
						...
						<button type="button" class="btn btn-primary add-medicine-btn">등록</button>
					</div>
				</div>
			</div>
		</div>
	...
	<script src="${pageContext.request.contextPath}/resources/dist/assets/js/pages/add-medicine.js"></script>
</body>
</html>